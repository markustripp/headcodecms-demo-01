...
export const footerSection = {
  ...
  fields: {
    company: TextField({
      label: 'Company Line',
      defaultValue: '© 2026 Your Company, Inc. All rights reserved.',
    }),
    nav: {
      label: 'Navigation',
      fields: {
...
export type FooterData = InferSectionData<typeof footerSection.fields>

export function Footer({ sectionData }: { sectionData: unknown }) {
  const { data } = parseSectionData(footerSection.fields, sectionData)
  ...
  return (
    <div>
      ...
      <p className="mt-10 text-center text-sm/6">{data.company}</p>
    </div>
  )
}
